...
public class Calculette  extends JApplet{
	/**
	 * 
	 */
	private static final long	serialVersionUID	= 378086997494788990L;
	...
	public void init(){
		...
		LastResultLabel.setFont(new Font("Arial", Font.PLAIN, 12));
	...
	private void parseCommand(char tmp1){
		switch (tmp1){
			case 'x':
			case '-':
			case '/':
			...
			case '=':
				...
				printOnMainScreen(LastResultString);
				break;
			case '.':
			...
			case '9':
				...
				break;
			default:
				System.out.println("Bug!, unrecognized arg to parse: " + tmp1);
		}// End switch 
	}
	...
	void printOnMainScreen(String Message){
		if (Message==null){
			MainPanelLabel.setText(FirstOperand + (Operation==' '?"":Operation) + SecondOperand);
		} else {
			MainPanelLabel.setText(Message);
		}
	}
