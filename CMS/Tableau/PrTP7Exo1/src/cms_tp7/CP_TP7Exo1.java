...
public class CP_TP7Exo1 {
	...
	public static void main(String args[]) {
		...
		System.out.println("\n23/0 vaut : " + (float) 23/0 + ".");				
		System.out.println("-23/0.0 vaut : "+ (float) -23/0.0+".");
		...
		System.out.println("'A' - 'a' vaut : " + ((int)varCar1 - (int)varCar2) + ".");
		...
		System.out.println("De m�me, ent1 apr�s le cast vaut " + ent1 + " !");
		
		short court1 = 32000;
		short court2 = (short)35000l;
		System.out.println("\nUne valeur correcte : court1 = " + court1 + ".");
		System.out.println("Une valeur \"inattendue\" : court2 = " + court2 + " !");
		
		short court3 = 1000, court4 = 2000;
		short court5;
		court5 = (short)((short)court3 + (short)court4);
