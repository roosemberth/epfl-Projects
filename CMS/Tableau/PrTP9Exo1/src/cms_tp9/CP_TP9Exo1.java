...
import cms_tp9.PMD_Private;
import cms_tp9.PMD_Public;

public class CP_TP9Exo1 {
	public static void main(String args[]){
		//Création d'un nouvel objet de type "PMD_Public"
		//dont la référence est stockée dans la variable objet
		//(ou la variable de type classe) "premierPoint" créée é cet effet
		...
		//System.out.println(deuxiemePoint);
